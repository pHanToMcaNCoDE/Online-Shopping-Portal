            ...
            <main class="brndForm" role="main">
                ...
                <div class="down">
                    <form class="bForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                        <div class="content">
                            <div class="item">
                                <label for="brandID">Full Name:</label>
                        ...
                        <div class="content">
                            <div class="item">
                                <label for="status">Tele-phone:</label>
                                <input type="text" name="phone" placeholder='e.g; +1-000-000-000'>
                            </div>
                            <div class="item">
                                <label for="rating">Business/Company Name:</label>
                        ...
                        <div class="content">
                            <div class="item">
                                ...
                                <input type="password" name="pwd" placeholder="e.g; Apple123">
                            </div>
                        </div>
                        <div class="brand-btn">
