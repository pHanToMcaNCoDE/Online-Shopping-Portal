...
<body>
    ...
    <body>
        ...
        <header>
            <nav>
                <div class="left">
                    ...
                    <svg id="left" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
        ...
        <section class="form-brand">
            <div class="max-width">
                <aside style="width: 18%; height: 100vh;">
                    <div class=" x">
                ...
                <main class="brandFrom" role="main">
                    <div class="deco">
                    ...
                    <div class="bForm">
                        <form class="bndForm" action="" method="POST">
                            <div class="content">
                                <div class="items">
